...
public class Main {
    public static void main(String[] args) {
        ...
        InitialiseerContent();
        //haal de gebruiker instantie op
        GetUserInstance();
    ...
    private static void GetUserInstance() {
    ...
    private static void bootup() {
        ...
        if (day.equals("day")){
            MessagePrinter printer2 = new DefaultMessagePrinter();
            printer2.printMessages();
        } else {
            MessagePrinter printer1 = new CustomMessagePrinter();
            printer1.printMessages();
        }
        System.out.println();
    }
